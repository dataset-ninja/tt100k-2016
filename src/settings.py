...
##################################
PROJECT_NAME: str = "Tsinghua Tencent 2016"
PROJECT_NAME_FULL: str = "Tsinghua Tencent 100K 2016 Dataset"
...
PREVIEW_IMAGE_ID: int = 14018401
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/tt100k-2016"
...
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = (
    "https://cg.cs.tsinghua.edu.cn/traffic-sign/data_model_code/data.zip"
)
